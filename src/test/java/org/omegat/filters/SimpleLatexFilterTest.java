...
public class SimpleLatexFilterTest extends TestFilterBase {
    ...
    @Test
    public void testFilterFeaturesWithoutEscape() throws Exception {
        ...
        assertEquals("Some non-breaking~space.", entries.get(i++));
    ...
    @Test
    public void testFilterFeaturesWithEscape() throws Exception {
